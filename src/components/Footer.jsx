        ...
        <section className="section section__mainFooter">
            <div className="container">
                ...
                <div className="socials">
                        ...
                        <a href="https://twitter.com/iyoha_osaro" target="_blank" rel="noreferrer" aria-label="Follow me on twitter">
                        ...
                        <a href="#instagram" aria-label="Instagram Link">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" className='instagramIcon'>
